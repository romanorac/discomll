...
fit_model = random_forest.fit(train, trees_per_chunk = 20, max_tree_nodes = 50, leaf_min_inst = 5, class_majority = 1)
predict_url = random_forest.predict(test, fit_model)
print predict_url
